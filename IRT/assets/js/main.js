...
/* ==========================================================================
 ...
 jQuery('#clock').countdown('2018/01/24',function(event){
  ...
  +'<div class="time-entry days"><span>%D</span> Dias/Days</div> '
  +'<div class="time-entry hours"><span>%H</span> Horas/Hours</div> '
  +'<div class="time-entry minutes"><span>%M</span> Min</div> '
  +'<div class="time-entry seconds"><span>%S</span> Seg/Secs</div> '));
});
