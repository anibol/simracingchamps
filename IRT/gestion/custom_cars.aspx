<%@ Page Title="" Language="C#" MasterPageFile="~/gestion/irtadmin.Master" AutoEventWireup="true" CodeBehind="custom_cars.aspx.cs" Inherits="IRT.gestion.custom_cars" meta:resourcekey="PageResource1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="content-header">
        <h1>
            <asp:Literal ID="Literal6" runat="server" Text="Gestión de Coches" meta:resourcekey="Literal6Resource1"></asp:Literal>&nbsp;<a href="custom_cars.aspx?n=1" class="btn btn-xs btn-success"><asp:Literal ID="Literal5" runat="server"  Text="Nuevo Coche" meta:resourcekey="Literal5Resource1"></asp:Literal></a>
        </h1>
        <ol class="breadcrumb">
            <li class="active">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
                            <asp:Literal ID="Literal2" runat="server" Text="Listado de coches" meta:resourcekey="Literal2Resource1"></asp:Literal></h3>
                    </div>
                    <div class="box-body">
                        <asp:Repeater ID="repCircuitos" runat="server">
                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <asp:Literal ID="Literal14" runat="server" Text="Coche" meta:resourcekey="Literal14Resource1"></asp:Literal></th>
                                            <th>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><a href='custom_cars.aspx?ed=<%# DataBinder.Eval(Container.DataItem,"ID") %>' class="btn btn-xs btn-primary">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">
                                <asp:Literal ID="Literal4" runat="server" Text="Añadir/Editar Coche" meta:resourcekey="Literal4Resource1"></asp:Literal></h3>
                        </div>
                        <!-- /.box-header -->
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">
                                            <asp:Literal ID="Literal22" runat="server" Text="Coche" meta:resourcekey="Literal22Resource1"></asp:Literal>:</label>
